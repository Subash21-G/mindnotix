    ...
    <div class="bg-white bg-opacity-20 backdrop-blur-md rounded-2xl p-8 shadow-lg w-full max-w-md text-center">
        ...
        <form method="POST" action="{{ route('login') }}" class="space-y-4">
            ...
            <div>
                ...
                <input type="text" id="login" name="email" placeholder="📧 Email or Username" value="{{ old('email') }}" class="w-full p-3 rounded-lg focus:outline-none" required autofocus>
            </div>
            <div>
        ...
        <p class="text-white mt-6 text-sm">
            ...
            <a href="{{ route('register') }}" class="underline hover:text-indigo-200">Register here</a>
        </p>
    </div>
</body>
</html>
