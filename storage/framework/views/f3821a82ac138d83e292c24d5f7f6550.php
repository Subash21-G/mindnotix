    ...
    <div class="bg-white bg-opacity-20 backdrop-blur-md rounded-2xl p-8 shadow-lg w-full max-w-md text-center">
        ...
        <form method="POST" action="<?php echo e(route('register')); ?>" class="space-y-4">
            ...
            <div>
                ...
                <input type="text" id="name" name="name" placeholder="👤 Full Name" value="<?php echo e(old('name')); ?>" class="w-full p-3 rounded-lg focus:outline-none" required autofocus>
            </div>
            <div>
                <label for="username" class="sr-only">Username</label>
                <input type="text" id="username" name="username" placeholder="🆔 Username" value="<?php echo e(old('username')); ?>" class="w-full p-3 rounded-lg focus:outline-none" required>
            </div>
            <div>
                <label for="email" class="sr-only">Email</label>
                <input type="email" id="email" name="email" placeholder="📧 Email" value="<?php echo e(old('email')); ?>" class="w-full p-3 rounded-lg focus:outline-none" required>
            </div>
            <div>
        ...
        <p class="text-white mt-6 text-sm">
            ...
            <a href="<?php echo e(route('login')); ?>" class="underline hover:text-purple-200">Login here</a>
        </p>
    </div>
</body>
</html>
<?php /**PATH C:\formnew\formApp\resources\views/auth/register.blade.php ENDPATH**/ ?>